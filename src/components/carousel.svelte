...
<style>
  ...
  .swiper-wrapper {
    align-items: center;
    margin-left: 0; /* slight offset for better centering */
    padding: 0 40px 0 0; /* padding to prevent clipping */
  }
  ...
  .swiper-slide {
    ...
    aspect-ratio: 9 / 13; /* consistent ratio (e.g. poster-like) */
    padding: 0;
